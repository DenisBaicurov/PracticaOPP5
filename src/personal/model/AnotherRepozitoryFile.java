...
public class AnotherRepozitoryFile implements Repository {
  private AnotherUserMapper mapper=new AnotherUserMapper();
  private FileOperation fileOperation;

    public AnotherRepozitoryFile(FileOperation fileOperation) {
